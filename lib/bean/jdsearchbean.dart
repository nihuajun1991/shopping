class JDSearchbean {
  ...
  String msg;
  String totalCount;
  List<JDSearchData> data;

  JDSearchbean({this.error, this.msg, this.totalCount, this.data});

  JDSearchbean.fromJson(Map<String, dynamic> json) {
    error = json['error'];
    msg = json['msg'];
    totalCount = json['totalCount'];
    if (json['data'] != null) {
      data = new List<JDSearchData>();
      json['data'].forEach((v) {
        data.add(new JDSearchData.fromJson(v));
      });
    }
  }
...
class JDSearchData {
  ...
  String materialUrl;
  String owner;
//  List<Null> pinGouInfo;
//  List<Null> pingGouInfo;
  PriceInfo priceInfo;
  ShopInfo shopInfo;
  String skuId;
  String skuName;
...
//        this.pingGouInfo,
  ...
  JDSearchData.fromJson(Map<String, dynamic> json) {
...
//      pinGouInfo = new List<Null>();
//      json['pinGouInfo'].forEach((v) {
//        pinGouInfo.add(new Null.fromJson(v));
//      });
//    }
//    if (json['pingGouInfo'] != null) {
//      pingGouInfo = new List<Null>();
//      json['pingGouInfo'].forEach((v) {
//        pingGouInfo.add(new Null.fromJson(v));
//      });
//    }
...
//      data['pinGouInfo'] = this.pinGouInfo.map((v) => v.toJson()).toList();
//    }
//    if (this.pingGouInfo != null) {
//      data['pingGouInfo'] = this.pingGouInfo.map((v) => v.toJson()).toList();
//    }
...
class CouponList {
  ...
  CouponList({this.bindType, this.discount, this.getEndTime, this.getStartTime,
    this.isBest, this.link, this.platformType, this.quota, this.useEndTime,
    this.useStartTime});
